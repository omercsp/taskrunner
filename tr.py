...
def _parse_arguments():
    ...
    task_target_parser.add_argument('task', nargs='?', metavar='TASK', default=None, help='Set task')
    ...
    run_parser.add_argument('-a', '--args', metavar='ARGS', action='append', default=[],
    ...
    subparsers.add_parser('dump', help='Dump a task', parents=[task_target_parser])
